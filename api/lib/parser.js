...
const publisher_places_js_1 = require("./publisher-places.js");
function fillPublishPlace(c) {
    if (c.type === 'book' && !c.publishPlace && c.publisher) {
        const place = (0, publisher_places_js_1.lookupPlace)(c.publisher);
        if (place)
...
function parseCitationText(text) {
    ...
    const id = (0, utils_js_1.generateId)();
    ...
    const language = (0, utils_js_1.detectLanguage)(normalizedText);
